...
exports.updateUserInfo = exports.checkForSlug = exports.refreshAccessToken = exports.logoutUser = exports.getUserData = exports.loginUser = exports.registerUser = exports.googleCallback = exports.authGoogle = void 0;
    ...
    try {
        ...
        const user = yield db_config_1.default.user.upsert({
            ...
            create: {
                ...
                provider: "GOOGLE",
                slug: (_a = profile === null || profile === void 0 ? void 0 : profile.name) === null || _a === void 0 ? void 0 : _a.split(" ").join("_").toLowerCase(),
            },
            update: {},
        });
...
exports.registerUser = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    user = yield db_config_1.default.user.create({
        data: {
            ...
            slug: name === null || name === void 0 ? void 0 : name.split(" ").join("_").toLowerCase(),
        },
    });
    const { accessToken, refreshToken } = yield (0, jwt_1.generateAccessAndRefreshTokens)({
        id: user === null || user === void 0 ? void 0 : user.id,
    ...
    res
        ...
        .cookie("accessToken", accessToken, constants_1.cookieOption)
        .cookie("refreshToken", refreshToken, constants_1.cookieOption)
        .json(new ApiResponse_1.default(200, { success: true }, "Registered Succesfully"));
    // .redirect(`${process.env.SUCCESS_REDIRECT_URL}`);
}));
exports.loginUser = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res
        ...
        .cookie("accessToken", accessToken, constants_1.cookieOption)
        .cookie("refreshToken", refreshToken, constants_1.cookieOption)
        .json(new ApiResponse_1.default(200, { success: true }, "Logged in Succesfully"));
    // .redirect(`${process.env.SUCCESS_REDIRECT_URL}`);
}));
...
// check for slug ----------
exports.checkForSlug = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const slug = req.params.slug;
        if (slug.length < 4) {
            throw new ApiError_1.default(400, "Minimum 4 characters are required");
        }
        const check = yield db_config_1.default.user.findFirst({
            where: { slug, id: { not: (_a = req.user) === null || _a === void 0 ? void 0 : _a.id } },
        });
        res
            .status(200)
            .json(new ApiResponse_1.default(200, { available: Boolean(!check) }, "Checking successfull"));
    }
    catch (error) {
        throw new ApiError_1.default(401, (error === null || error === void 0 ? void 0 : error.message) || "Error in Checking slug");
    }
}));
// update user info ----------
