...
const authRouter = (router) => {
    ...
    router.put("/user", auth_middleware_1.verifyJWT, (0, validate_middleware_1.default)(auth_schema_1.updateUserSchema), auth_controller_1.updateUserInfo);
    router.get("/user/checkslug/:slug", auth_middleware_1.verifyJWT, auth_controller_1.checkForSlug);
